	...
	return (
		<>
			<Head>
				...
				<meta
					name="description"
					content="Guide to install Theme Library plugin for Vencord and customize your Discord interface."
				/>
			</Head>
				...
				<div className="max-w-4xl mx-auto space-y-8">
					<div className="text-center space-y-4">
						...
						<div className="flex flex-wrap justify-center gap-4">
							<Button
								variant="outline"
								onClick={() =>
									window.open("https://vencord.dev", "_blank")
								}
							>
					...
					<Alert className="bg-muted text-muted-foreground border border-border rounded-2xl shadow-sm mb-4">
						<div className="flex items-start gap-3">
							...
							<div>
								...
								<AlertDescription>
									You will not receive support for dev
									installs! Only do this if you ACTUALLY know
									what you're doing.
								</AlertDescription>
							</div>
						</div>
					...
					<Card>
						...
						<CardContent className="space-y-6">
							{installSteps.map(
								({ id, title, command, platformCommands }) => (
									<div key={id} className="space-y-2">
										...
										<div>
											{platformCommands ? (
												<div className="space-y-4">
													<div>
														...
														<div className="overflow-x-auto">
															<code className="block bg-secondary text-foreground p-3 rounded-md font-mono text-sm">
																{renderCommandLines(
																	platformCommands.linux
																)}
															</code>
														</div>
													</div>
												...
												<div className="overflow-x-auto">
													<code className="block bg-secondary text-foreground p-3 rounded-md font-mono text-sm max-w-full">
														{renderCommandLines(
															command
														)}
													</code>
