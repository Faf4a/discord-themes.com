    ...
    return (
        <>
            ...
            <div className="min-h-screen bg-background">
                ...
                <ScrollArea className="h-[calc(100vh-4rem)] description break-words">
                        ...
                        <div className="max-w-3xl mx-auto space-y-8">
                            ...
                            <section className="prose prose-sm max-w-none dark:prose-invert">
                                ...
                                <ul>
                                    ...
                                    <li>
                                        <strong>Company</strong> (referred to as either &quot;the Company&quot;, &quot;We&quot;, &quot;Us&quot; or &quot;Our&quot; in this Agreement) refers to Theme Library.
                                    </li>
                                    <li>
                                    ...
                                    <li>
                                        <strong>Website</strong> refers to Theme Library, accessible from{" "}
                                        <a href="https://discord-themes.com" rel="external nofollow noopener" target="_blank">
                                ...
                                <ul>
                                    <li>
                                        <a href="https://discord.com">Discord Inc.</a>
                                    </li>
                                </ul>
                                <p>If You decide to register through or otherwise grant us access to a Third-Party Social Media Service, We may collect Personal data that is already associated with Your Third-Party Social Media Service's account.</p>
                                ...
                                <ul>
                                    ...
                                    <li>
                                        <strong>For other purposes</strong>: We may use Your information for other purposes, such as data analysis, identifying usage trends, to evaluate and improve our Service, and your experience.
                                    </li>
                                </ul>
                            ...
                            <section className="border-t border-muted pt-8">
                                ...
                                <ul className="list-disc list-inside">
                                    <li>
                                        By email:{" "}
                                        <a href="mailto:privacy@discord-themes.com" className="text-primary hover:underline">
