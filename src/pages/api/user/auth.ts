...
export default async function GET(req: NextApiRequest, res: NextApiResponse) {
    ...
    const tokenResponse = await fetch("https://discord.com/api/oauth2/token", {
        ...
        body: new URLSearchParams({
            ...
            redirect_uri: process.env.NODE_ENV === "production" ? "https://discord-themes.com/api/user/auth?callback=/auth/callback" : "http://127.0.0.1:4321/api/user/auth?callback=/auth/callback",
